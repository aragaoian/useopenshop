      ...
      <div className="pt-24 pb-16">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="prose prose-sm max-w-none text-foreground/80 space-y-6">
            ...
            <p>Ao utilizar o Openshop, você concorda com estes Termos de Serviço. Se não concordar, por favor não utilize a plataforma.</p>
            ...
            <p>Todos os preços são exibidos em Reais (R$). O Openshop atua como intermediário entre compradores e vendedores. A responsabilidade pelo produto é do vendedor.</p>
            ...
            <p>O Openshop não se responsabiliza por disputas entre compradores e vendedores, mas oferece suporte para mediação.</p>
            <h2 className="font-heading text-xl font-semibold text-foreground">7. Contato</h2>
            <p>Para questões sobre estes termos: <strong>contato@openshop.com.br</strong></p>
          </div>
        </div>
      </div>
    </Layout>
